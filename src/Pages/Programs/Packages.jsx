    ...
    <section className="w-full h-auto pt-[21px] lg:pt-[43px] bg-[#F2F2F2]">
      <div className=" pb-[59px] lg:pb-[60px]">
        <div className="container w-full">
          <span className="flex flex-col-reverse lg:flex-row justify-between items-center mb-[10px]">
            ...
            <div className=" rounded-[1000px] flex overflow-hidden p-[4px] bg-white">
              <button
                ...
                className="flex-1 py-[10px] px-[20px] font-semibold text-sm lg:text-lg leading-[16.8px] lg:leading-[21.6px] h-[46px] lg:h-[52px] bg-darkgreen rounded-[1000px] text-mediumgreen w-auto"
              >
                All
              </button>
              <button
                onClick={() => filterItemsByTag("Academic")}
                className="flex-1 py-[10px] px-[20px] text-darkgreen font-semibold text-sm lg:text-lg leading-[16.8px] lg:leading-[21.6px] h-[46px] lg:h-[52px]"
              >
                Educational
              </button>
              <button
